...
if TG_BOT_USER_NAME_BF_HER is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("alive") and event.query.user_id == me.id:
            buttons = [
                [
                    Button.url("Repo", "https://github.com/DARKLONXOP/DARKLONX-BOT"),
                    Button.url("Deploy", "https://heroku.com/deploy?template=https://github.com/legendx22/DARKLONX-BOT/blob/master")],
                    [Button.url("String", "https://repl.it/legendx22/DARKLONX-BOT#main.py"),
