# COPYRIGHT (C) 2021-2022 © BY DARKLONXOP22 AND PROBOYX 🔥
"""
(((((((((((((((((((((((@DARKLONXOP22)))))))))))))))))))))))))))
(((((((((((((((((((((((@DARKLONXOP22)))))))))))))))))))))))))))
(((((((((((((((((((((((@DARKLONXOP22)))))))))))))))))))))))))))
(((((((((((((((((((((((@DARKLONXOP22)))))))))))))))))))))))))))
               MADE BY DARKLONXOP22 AND PROBOYX
                 CREDITS TEAMLEGEND
               DONT REMOVE THIS LINES
"""
from userbot.utils import admin_cmd
from DARKLONXOP import xbot, NAME
...
async def Buttons(event):
  ...
  pro = event.text[7:]
  pro, boy = pro.split("|")
  if "DARKLONXOP" == "PROBOYX":
    await xbot.send_message(event.chat_id, "buttons")
  else:
    try:
      async with bot.conversation(DARKLONXOP) as proboyx:
