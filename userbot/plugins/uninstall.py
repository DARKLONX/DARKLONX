...
from DARKLONX.events import remove_plugin, load_module
from telethon import functions, types
from telethon.tl.types import InputMessagesFilterDocument
from DARKLONX.utils import command, remove_plugin, load_module
from pathlib import Path
from DARKLONX import LOAD_PLUG, CMD_HELP
...
async def unload(event):
    ...
    dir_path =f"./DARKLONX/plugins/{shortname}.py"
    try:
